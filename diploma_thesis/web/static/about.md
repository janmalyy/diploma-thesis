...
The tool is not designed, intended, or made available for use in the diagnosis, prevention, mitigation, or treatment of a disease or medical condition nor to perform any medical function and the performance of the tool for such purposes has not been established. You bear sole responsibility for any use of the tool, including incorporation into any product intended for a medical purpose.
(adopted from [EvAgg](https://www.biorxiv.org/content/10.1101/2025.03.10.642480v2.full))
